...
const serviceTabContent = {
  'App Development': [
    { title: "iOS Native Apps", desc: "High-performance applications designed specifically for the Apple ecosystem.", img: "1611162617474-5b21e879e113" },
    { title: "Android Apps", desc: "Robust and scalable Android development reaching millions of global mobile users.", img: "1551288049-bebda4e38f71" },
    { title: "Cross-Platform", desc: "React Native and Flutter solutions maintaining near-native speed and high aesthetic quality.", img: "1498050108023-c5249f4df085" },
    { title: "Mobile Strategy", desc: "Comprehensive planning to ensure your application achieves its business objectives.", img: "1556761175-5973dc0f32e7" },
    { title: "Backend Systems", desc: "Secure, fast, and highly scalable server-side architecture powering your mobile app.", img: "1558494949-ef010cbdcc31" },
    { title: "Quality Assurance", desc: "Rigorous automated and manual testing to guarantee a flawless user experience.", img: "1517694712202-14dd9538aa97" }
  ],
  'UI/UX Design': [
    { title: "User Research", desc: "In-depth target audience analysis to form the foundation of our design strategy.", img: "1531403009284-440f080d1e12" },
    { title: "Wireframing", desc: "Low-fidelity structural layouts to map out effective user journeys and content.", img: "1618761714954-0b8cd0026356" },
    { title: "Visual Design", desc: "Stunning, high-fidelity interfaces that establish unparalleled brand equity.", img: "1522542550221-31fd19575a2d" },
    { title: "Interactive Prototyping", desc: "Clickable prototypes allowing you to experience the product before development begins.", img: "1504868584819-f8e8b4b6d7e3" },
    { title: "Usability Testing", desc: "Observing real users interacting with the design to identify friction points.", img: "1573164713988-8665fc963095" },
    { title: "Design Systems", desc: "Scalable component libraries ensuring absolute consistency across all digital touchpoints.", img: "1516321318423-f06f85e504b3" }
  ],
  'Project Management': [
    { title: "Agile Development", desc: "Iterative delivery methodologies providing maximum flexibility and visibility.", img: "1522071820081-009f0129c71c" },
    { title: "Scrum Master Services", desc: "Dedicated facilitation to remove team blockers and maintain high velocity.", img: "1531482615713-2afd69097998" },
    { title: "Risk Mitigation", desc: "Proactive identification and resolution of potential project roadblocks.", img: "1454165804606-c3d57bc86b40" },
    { title: "Resource Allocation", desc: "Optimized distribution of talent to ensure your project stays completely on schedule.", img: "1542744173-8e7e53415bb0" },
    { title: "Budget Tracking", desc: "Transparent financial monitoring providing complete control over project spend.", img: "1460925895917-afdab827c52f" },
    { title: "Stakeholder Reporting", desc: "Clear, consistent communication keeping all parties aligned on project status.", img: "1556761175-5973dc0f32e7" }
  ],
  'HR Management': [
    { title: "Talent Acquisition", desc: "Strategic sourcing to identify and attract top-tier technical professionals.", img: "1451187580459-43490279c0fa" },
    { title: "Onboarding Programs", desc: "Streamlined integration processes accelerating new hire time-to-productivity.", img: "1521791136064-7986c2920216" },
    { title: "Performance Reviews", desc: "Structured evaluation systems promoting continuous improvement and growth.", img: "1551836022-d5d88e9218df" },
    { title: "Culture Development", desc: "Initiatives fostering a positive, inclusive, and highly productive work environment.", img: "1523240795612-9a054b0db644" },
    { title: "Benefits Administration", desc: "Comprehensive management of employee benefits, health plans, and compensation.", img: "1460925895917-afdab827c52f" },
    { title: "Compliance & Legal", desc: "Ensuring all operational practices adhere to current employment law standards.", img: "1589829085413-56de8ae18c73" }
  ],
  'SEO & Marketing': [
    { title: "Technical SEO", desc: "Deep architectural optimizations ensuring maximum search engine crawlability.", img: "1497215728101-856f4ea42174" },
    { title: "Content Strategy", desc: "Data-driven editorial planning that establishes authoritative industry leadership.", img: "1542744173-8e7e53415bb0" },
    { title: "PPC Campaigns", desc: "Highly targeted paid advertising designed to maximize your return on ad spend.", img: "1486312338219-ce68d2c6f44d" },
    { title: "Social Media Tactics", desc: "Engaging community management and brand building across modern platforms.", img: "1611162617474-5b21e879e113" },
    { title: "Conversion Optimization", desc: "A/B testing and analytical refinement converting more site visitors into distinct leads.", img: "1497366216548-37526070297c" },
    { title: "Analytics Reporting", desc: "Comprehensive tracking providing crystal-clear visibility into all marketing efforts.", img: "1517694712202-14dd9538aa97" }
  ]
};
...
export default function Home() {
  ...
  const [activeServiceTab, setActiveServiceTab] = useState('Website Development');
  ...
  return (
    <main className="w-full font-sans text-slate-900 bg-slate-50/50 selection:bg-blue-600/30 relative overflow-x-hidden">
      ...
      <section id="services" className="py-24 px-6 md:px-24 mb-10 bg-navy-900 border-t border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 border border-slate-700/50 rounded-[3rem] p-8 md:p-16 bg-navy-900/60 backdrop-blur-lg shadow-2xl overflow-hidden">

          {/* Cyber Diamond Graphic Background */}
          <div className="absolute -bottom-24 left-[75%] -translate-x-1/2 w-40 h-56 md:w-56 md:h-72 -z-10 pointer-events-none opacity-40 mix-blend-screen mix-blend-color-dodge filter blur-md">
            <div className="w-full h-full relative" style={{ animationDuration: '8s' }}>
              <div className="w-0 h-0 border-l-[80px] md:border-l-[112px] border-l-transparent border-r-[80px] md:border-r-[112px] border-r-transparent border-b-[112px] md:border-b-[144px] border-b-blue-500 drop-shadow-[0_0_20px_rgba(59,130,246,0.5)] absolute top-0" />
              <div className="w-0 h-0 border-l-[80px] md:border-l-[112px] border-l-transparent border-r-[80px] md:border-r-[112px] border-r-transparent border-t-[112px] md:border-t-[144px] border-t-purple-400 drop-shadow-[0_0_20px_rgba(168,85,247,0.5)] absolute bottom-0" />
              <div className="absolute inset-0 bg-gradient-to-tr from-pink-300/40 via-purple-300/40 to-cyan-300/40 mix-blend-overlay clip-diamond" style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }} />

              {/* Highlights Softened */}
              <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent clip-diamond blur-xl" style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }} />
            </div>
          </div>

          <div className="text-center mb-16 border-b border-slate-700 pb-6 inline-block mx-auto relative z-10">
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white tracking-wide">Our Service</h2>
          </div>

          <ScrollLinkedRevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Project Management", icon: Briefcase, desc: "Explore a wide array of artistic styles and themes to apply to your projects. Streamlining workflows with expert management." },
              { title: "Website Development", icon: Globe, desc: "Explore a wide array of artistic styles and themes to apply to your online presence. Responsive and secure web solutions." },
              { title: "HR Management", icon: Users, desc: "Explore a wide array of artistic styles and themes to apply to your workforce. Comprehensive HR solutions." }
            ].map((service, i) => (
              <div
                key={i}
                className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-[2rem] group hover:bg-white/10 transition duration-500 shadow-2xl shadow-black/20 h-full flex flex-col"
              >
                <div className="w-20 h-20 bg-white flex items-center justify-center rounded-[1.5rem] mb-10 group-hover:scale-105 transition shadow-lg shrink-0">
                  <service.icon className="w-10 h-10 text-slate-900 stroke-[1.5]" />
                </div>
      ...
      <section className="py-24 px-6 md:px-24 bg-surface-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-[2.5rem] font-display font-bold text-slate-900 mb-6">{activeServiceTab}</h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">We follow a structured process to deliver high-quality solutions perfectly tailored for your brand.</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 mb-24">
            {[
              ...
              <div onClick={() => setActiveServiceTab(item.label)} key={i} className={`flex flex-col items-center gap-4 group cursor-pointer ${activeServiceTab === item.label ? 'text-blue-600' : 'text-slate-700'}`}>
                <div className={`w-20 h-20 rounded-full border flex items-center justify-center transition shadow-sm ${activeServiceTab === item.label ? 'bg-blue-600 text-white border-blue-600 shadow-md scale-110' : 'bg-white border-gray-100 group-hover:shadow-md group-hover:border-blue-200 group-hover:text-blue-600'}`}>
          ...
          {/* Dynamic Content Based on Active Toggle */}
          {activeServiceTab === 'Website Development' ? (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col lg:flex-row items-center gap-16">
              <div className="w-full lg:w-1/2">
              ...
              <div className="w-full lg:w-1/2">
                <h3 className="text-3xl font-bold mb-6 text-slate-900">Streamlining Digital Experiences for the Modern Web</h3>
                <p className="text-slate-500 mb-12 text-lg leading-relaxed">We architect blazing-fast, highly scalable web solutions using next-generation technologies. From complex enterprise applications to immersive branding sites, our engineering process ensures absolute performance.</p>

                <div className="space-y-12 relative before:absolute before:inset-0 before:ml-[1.4rem] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-[2px] before:bg-gradient-to-b before:from-transparent before:via-blue-200 before:to-transparent">
                  {[
                    { title: "Planning", desc: "Define goals and structure." },
                    { title: "Design", desc: "Create visual aesthetics." },
                    { title: "Development", desc: "Build the solution." }
                  ].map((step, i) => (
                    <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      <div className="flex items-center justify-center w-12 h-12 rounded-full border-4 border-white bg-blue-600 text-white shadow-md shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 font-bold text-lg">
                        {i + 1}
                      </div>
                      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] pl-6 md:pl-0 md:group-odd:pr-10 md:group-even:pl-10 text-left md:group-odd:text-right">
                        <h4 className="font-bold text-slate-900 text-xl mb-2">{step.title}</h4>
                        <p className="text-slate-500 text-base">{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {(serviceTabContent[activeServiceTab as keyof typeof serviceTabContent] || serviceTabContent['App Development']).map((item, i) => (
                <div className="flex gap-6 bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition group cursor-pointer" key={i} onClick={() => openModal(`Service Details: ${item.title}|^^|${item.desc}\n\nOur specialists bring years of domain-specific expertise to execute this phase with absolute precision, utilizing data-driven methodologies and best practices to guarantee exceptional quality and seamless integration.`)}>
                  <div className="w-1/3 aspect-[4/3] bg-slate-200 rounded-2xl flex-shrink-0 relative overflow-hidden group-hover:scale-105 transition duration-500">
                    <Image fill src={`https://images.unsplash.com/photo-${item.img}?auto=format&fit=crop&q=80`} alt={item.title} className="object-cover" sizes="33vw" />
                  </div>
                  <div className="flex flex-col justify-center w-2/3">
                    <h4 className="font-bold text-slate-900 text-lg mb-2">{item.title}</h4>
                    <p className="text-sm text-slate-500 line-clamp-3 leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </motion.div>
